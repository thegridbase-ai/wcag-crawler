...
<div class="page">
    ...
    <div class="icard">
      ...
      <div class="ibody">
        ${improvements.length > 0
          ? improvements.map(s => `<div class="iitem"><span class="iico b">&#9655;</span><span>${s}</span></div>`).join('')
          : '<div class="iitem"><span class="iico g">&#10003;</span><span>No significant improvements needed!</span></div>'
        }
      </div>
    </div>
  </div>
  ...
  <div class="ftr">
    ...
    <span>WCAG 2.1 AA &middot; axe-core &middot; ${reportDate}</span>
  </div>
